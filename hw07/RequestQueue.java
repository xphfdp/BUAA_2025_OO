...
public class RequestQueue {
    ...
    private Update updateRequest;
    private List<ScheRequest> scheRequests;
    private List<Update> updateRequests;
    ...
    public synchronized boolean isAllFinished() {
        return personList.isEmpty() && scheRequest == null && updateRequest == null;
    }
    ...
    public synchronized boolean isUpdateEmpty() {
    ...
    public synchronized void setUpdateRequest(Update updateRequest) {
    ...
    public synchronized Update getOneUpdateRequest() {
        if (updateRequests.isEmpty()) {
            return null;
        }
        Update updateRequest = updateRequests.get(0);
        updateRequests.remove(updateRequest);
    ...
    public synchronized Update getUpdateRequest() {
        return updateRequest;
    }
    ...
    public synchronized void addUpdateRequest(Update updateRequest) {
    ...
    public synchronized Person getOneRequest() {
        ...
        if (personList.isEmpty() || !scheRequests.isEmpty() || !updateRequests.isEmpty()) {
            return null;
        }
